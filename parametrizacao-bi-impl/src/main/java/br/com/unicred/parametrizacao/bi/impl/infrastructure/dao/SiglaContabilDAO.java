...
public class SiglaContabilDAO {
	...
	private static final String BUSCA_SIGLA_CONTABIL_SQL = "select codigo, sigla_contabil, ordem from ods.sigla_contabil";
	...
	public void exibeLista() {
		List<SiglaContabil> lista = buscaSiglasContabeis();
